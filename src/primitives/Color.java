...
public class Color {
     ...
     * whatever...
     */
	//to compare between 2 Color objects - it could be different in DELTA
	 ...
	 * @return if two Color objects are equals
	 */
	@Override
	public boolean equals(Object obj) {
		...
		//if the different is less than DELTA the colors are equal
		return Math.abs(this._r - other._r) < DELTA && Math.abs(this._g - other._g) < DELTA && Math.abs(this._b - other._b) < DELTA;
	}
