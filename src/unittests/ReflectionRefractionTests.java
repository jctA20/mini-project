	...
	public void selfTest() {
		...
		scene.addGeometries( //
				//new Triangle(Color.BLACK, new Material(0.5, 0.5, 60), //
						//new Point3D(-150, 150, 115), new Point3D(150, 150, 135), new Point3D(75, -75, 150)), //
				new Triangle(Color.BLACK, new Material(0.5, 0.5, 60), //
						new Point3D(-10, 150, 115), new Point3D(-70, -70, 140), new Point3D(100, -75, 130)), //
				new Sphere(new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.4, 0), // )
					 new Point3D(-10, -70, 50),20));

		scene.addLights(new SpotLight(new Color(700, 400, 400), //
				new Point3D(-10, -70, 0), new Vector(0, 0, 1), 1, 4E-5, 2E-7));

		ImageWriter imageWriter = new ImageWriter("selfTest", 200, 200, 600, 600);
		Render render = new Render(imageWriter, scene).setMultithreading(3) //
				.setDebugPrint();
